...
use Wildwestriverrider\LaravelMysqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\Wildwestriverrider\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testDistanceValue()
    {
        ...
        $this->assertEquals(1.4142135624, number_format($a[1]->distance, 10)); // PHP floats' 11th+ digits don't matter
    }
    ...
    public function testDistanceSphereValue()
    {
        ...
        if ($this->after_fix) {
            $this->assertEquals(44.7414064842, number_format($a[1]->distance, 10)); // PHP floats' 11th+ digits don't matter
        } else {
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\Wildwestriverrider\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
