...
class SpatialTraitTest extends BaseTestCase
{
    ...
    public function testInsertUpdateLineStringHasCorrectSql()
    {
        ...
        $this->model->linestring = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdatePolygonHasCorrectSql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $linestring2 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);

        $this->assertFalse($this->model->exists);

        $this->model->polygon = new \Wildwestriverrider\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPointHasCorrectSql()
    {
        ...
        $this->model->multipoint = new \Wildwestriverrider\LaravelMysqlSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiLineStringHasCorrectSql()
    {
        ...
        $this->model->multilinestring = new \Wildwestriverrider\LaravelMysqlSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPolygonHasCorrectSql()
    {
        ...
        $point4 = new Point(2, 1);
        $linestring2 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);
        $polygon1 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);

        $point5 = new Point(4, 5);
        $point6 = new Point(5, 6);
        $linestring3 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point5, $point6]);
        $point7 = new Point(6, 5);
        $point8 = new Point(5, 4);
        $linestring4 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point7, $point8]);
        $polygon2 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\Polygon([$linestring3, $linestring4]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Wildwestriverrider\LaravelMysqlSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function testInsertUpdateGeometryCollectionHasCorrectSql()
    {
        ...
        $linestring1 = new \Wildwestriverrider\LaravelMysqlSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Wildwestriverrider\LaravelMysqlSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
    ...
    public function testScopeDistance()
    {
        ...
        $this->assertInstanceOf(\Wildwestriverrider\LaravelMysqlSpatial\Eloquent\Builder::class, $query);
        $q = $query->getQuery();
    ...
    public function testScopeDistanceValue()
    {
        ...
        $this->assertEquals('st_distance(`point`, ST_GeomFromText(?, ?, \'axis-order=long-lat\')) as distance', $q->columns[1]->getValue($q->grammar));
        $this->assertEquals('POINT(2 1)', $bindings[0]);
    }
    ...
    public function testScopeDistanceSphereValue()
    {
        ...
        $this->assertEquals('*', $q->columns[0]);
        $this->assertInstanceOf(\Illuminate\Database\Query\Expression::class, $q->columns[1]);
        $this->assertEquals('st_distance_sphere(`point`, ST_GeomFromText(?, ?, \'axis-order=long-lat\')) as distance', $q->columns[1]->getValue($q->grammar));
        $this->assertEquals('POINT(2 1)', $bindings[0]);
    }
    ...
    public function testScopeOrderBySpatialThrowsExceptionWhenFunctionNotRegistered()
    {
        $point = new Point(1, 2);
        $this->assertException(
            \Wildwestriverrider\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class,
            'does-not-exist'
        );
